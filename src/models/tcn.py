...
class TemporalBlock(nn.Module):
    ...
    sequence length is restored:
        output length = T + pad - dilation*(kernel_size-1) = T  (ok)
    ...
    A 1x1 conv is used when the channel dimensions differ.
    """
    ...
    def __init__(
        ...
        # 1x1 conv maps in_channels -> out_channels for the residual path
